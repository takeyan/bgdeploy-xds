...
import (
        ...
        "bgdeploy-xds/pkg/apis"
        "bgdeploy-xds/pkg/controller"
        "bgdeploy-xds/version"
...
// import for envoy control-plane:
//        "context"
//        "flag"
//        "os"
//        "fmt"
        ...
        example "bgdeploy-xds/pkg/xdshelper"
        "github.com/google/uuid"

)
// Global variables for envoy control-plane:
var (
	l example.Logger
...
func main() {
// start envoy control-plane first:
		go xds()
        ...
        err = leader.Become(ctx, "bgdeploy-lock")
        if err != nil {
                log.Error(err, "")
                os.Exit(1)
        }
...
// functions for envoy control-plane:
